...
<template>
  <div class="column">
    <svg role="icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-labelledby="color-scheme-dark" class="change-theme" @mouseenter="$emit('hoverIn')" @mouseleave="$emit('hoverOut')" @click="changeTheme">
